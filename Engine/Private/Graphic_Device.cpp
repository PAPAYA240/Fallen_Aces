...
CGraphic_Device::CGraphic_Device() : m_pSDK(nullptr), m_pDevice(nullptr), m_pSprite(nullptr), m_pFont(nullptr)
{
}


HRESULT CGraphic_Device::Init_Device(HWND hWnd, _uint iWinSizeX, _uint iWinSizeY, LPDIRECT3DDEVICE9* ppGraphic_Device)
{
...
CGraphic_Device * CGraphic_Device::Create(HWND hWnd, _uint iWinSizeX, _uint iWinSizeY, LPDIRECT3DDEVICE9* ppGraphic_Device)
{
	CGraphic_Device*		pInstance = new CGraphic_Device();

	if (FAILED(pInstance->Init_Device(hWnd, iWinSizeX, iWinSizeY, ppGraphic_Device)))
	{
