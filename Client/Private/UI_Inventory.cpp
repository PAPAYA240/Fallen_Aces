...
CUI_Inventory::CUI_Inventory(CUI_Inventory& rhs)
    :CUI(rhs)
{
}
...
HRESULT CUI_Inventory::Set_RenderState()
{
...
HRESULT CUI_Inventory::Reset_RenderState()
{
...
CUI_Inventory* CUI_Inventory::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
    ...
    {
        MSG_BOX(TEXT("Failed To Created : UI_Inventory Class"));
...
CGameObject* CUI_Inventory::Clone(void* pArg)
{
    ...
    {
        MSG_BOX(TEXT("Failed To Cloned : UI_Inventory Class"));
