...
public:
	const ITEM_ID&			Get_ItemType()			const		{ return m_eItemID; }		/* 무기 종류 정보를 수집해서 플레이어가 들고있는 아이템 바꾸면 됨 */
...
protected:
	ITEM_ID					m_eItemID = { ITEM_ID::_END };					/* 아이템 타입 */
	ITEM_DURA				m_eDuraType = { ITEM_DURA::_END };				/* 현재 무기 내구도 상태 */
	ITEM_TYPE				m_eItemType = { ITEM_TYPE::_END };				/* 아이템의 종류 */
